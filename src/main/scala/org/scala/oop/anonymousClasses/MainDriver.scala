...
object MainDriver extends App {
    ...
    val integersList = new MyConcreteList[Int](1, EmptyList).add(2).add(3).add(4).add(5).add(6)
...
//  Testing flatmap operation
  ...
  val sameIntegerList = new MyConcreteList[Int](1, EmptyList).add(2).add(3).add(4).add(5).add(6)
